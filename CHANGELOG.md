...
#### Fixed
- Add include for bootstrap in database dump & details functions. Sets up DotENV. 
...
## [4.1.12] - 2026-08-18
#### Changed
- Adjusted styling of upcoming-anniversary-dates on desktop.
- Rework output of single family display on mobile.  
- Adjust styling of form on PDF for Booklet Printing options. 

### Fixed
- Correct issue of repeated anniversary date on display. 

## [4.1.11] - 2026-07-21
### Fixed
- Adjusted display of all forms to correct mis-alignment on desktop introduced in v4.1.9.

## [4.1.10] - 2026-07-21
### Fixed
- Adjusted display of family record to correct mis-alignment on desktop.

## [4.1.9] - 2026-07-21
### Changed
- Added Bootstrap 5 responsive navigation with hamburger menu behavior for tablet and mobile views.
- Applied responsive layouts to family management forms, print pages, and directory listing displays.
- Improved spacing and readability for staff, leadership, vestry, and family listing screens.
...
## [4.1.5] - 2026-06-17
### Removed
- Cloud Connect Navigation Tree. Commented out. 
...
### Changed
- Corrected issue with marriage anniversaries listing all family members
- Change marriage anniversary, birthday and baptism dates display to mm/dd. 
- Addjusteds the width of the anniversary display to allow 1 line per entry. 
...
- spacing on display of family lines to add white space.

## [4.0.15] - 2026-03-01

### Changed

- Centralized family search logic with fuzzy suggestions reused across edit, display, and delete flows.

## [4.0.14] - 2026-03-01

### Added

- Added framework to access email service via api.   

## [4.0.13] - 2026-03-01

### Added

- Added logo to app in upper left of each page.  

## [4.0.12] - 2026-03-01

### Changed

- Move header functions to own file for clarity.
- Update includes app wide.   

## [4.0.11] - 2026-02-21

### Added

- Google analytics called to begin recording.  
...
- Option to export CSV list of email addresses with names. 
...
- Fixed date comparison logic for anniversary display. 

## [4.0.7] - 2026-01-07

### Added

- Add logic to manage updating intro files. 

## [4.0.6] - 2026-01-02

### Changed

- Adjust font size for longer name, even if last name is the same as family name. 

## [4.0.5] - 2026-01-02

### Changed

- Modified db to handle 3 line address fields of longer length
- Display address on up to 4 separate lines

## [4.0.4] - 2025-12-03

### Changed

- Modified output of intro text files to display custom title. 
- Changed year on title page to be dynamic. 
- Adjusted width of family editing screen form. 
- Output all names as capitalized.
- Rework printed output to adjust font size on lines with long names. 
...
- Adjusted styling of password setup form. 

## [4.0.1] - 2025-12-02

### Changed

- Adjusted styling of login form. 
- Move all inline styles to style.css file. 

## [4.0.0] - 2025-12-02

### Add

- Added authentication to app. Enables users to register with their email address (which must be present in the members table). Prevents unauthorized users from access.

## [3.1.10] - 2025-12-01

### Change

- Rework display of anniversary since data field moved to members table.
- Lint each file touched to align with WP coding standards. 
- Navigation heading from Google Cloud to Cloud Connect 

### Remove

- Google CSV output option

### Fix

- Correct issue with main output loops not processing last family. 
