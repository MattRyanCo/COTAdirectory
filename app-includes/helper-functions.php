...
function cota_page_header() {
	...
	//  if ( file_exists( $constants->COTA_APP_INCLUDES . 'class-app-meta-data.php' ) ) {
	//      include_once $constants->COTA_APP_INCLUDES . 'class-app-meta-data.php';
	//      if ( class_exists( 'App_Meta_Data' ) ) {
	//          $meta_file = $constants->COTA_APP_FILE ?? '../index.php';
		...
		<ul>
			...
			<li class="has-submenu">
				...
				<ul class="submenu">
					...
					<li><a href="/app-includes/upload-information-docs.php">Upload Informational Documents</a></li>
