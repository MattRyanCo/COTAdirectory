	...
	for ( $lctr = 1; $lctr <= 4; $lctr++ ) {
		if ( $lctr == 1 ) {
			...
			if ( $addr1 ) {
				...
				if ( $print_it ) {
					$formatted_family_array[ $lctr ][1] = $family['address'];
				}
				$addr1 = false;
				if ( $addr2 ) {
					$left_side .= ', ' . $family['address2'] . ' ';
					if ( $print_it ) {
						$formatted_family_array[ $lctr ][1] = $family['address'] . ', ' . $family['address2'];
					}
					$addr2 = false;
				}
			} elseif ( $home_phone ) {
				...
				if ( $print_it ) {
					$formatted_family_array[ $lctr ][1] = 'Home: ' . $family['homephone'];
				}
				$addr2      = false;
				$city       = false;
				$home_phone = false;
				...
				if ( $print_it ) {
					$formatted_family_array[ $lctr ][1] = $formatted_family_array[ $lctr ][2] = $formatted_family_array[ $lctr ][3] = '';
				}
				$addr2 = false;
				$city  = false;
			}
